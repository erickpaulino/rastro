  ...
  <div>
    ...
    <div class="stacked-card">
      <div class="download-card">
        <h2><?= htmlspecialchars(rastro_t('auth.download.title'), ENT_QUOTES, 'UTF-8') ?></h2>
        <p><?= htmlspecialchars(rastro_t('auth.download.description'), ENT_QUOTES, 'UTF-8') ?></p>
        <a href="https://www.tapuya.com.br/rastro/rastro-installer.zip">
          <?= htmlspecialchars(rastro_t('auth.download.button'), ENT_QUOTES, 'UTF-8') ?>
        </a>
      </div>
    </div>
  </div>
