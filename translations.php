...
$RASTRO_TRANSLATIONS = [
    'pt' => [
        ...
        'auth.download.title' => 'Download do instalador',
        'auth.download.description' => 'Versão 1.0 (30/nov/2025) para instalar o Rastro Timeline no seu servidor.',
        'auth.download.button' => 'Baixar rastro-installer.zip',
    ...
    'en' => [
        ...
        'auth.download.title' => 'Installer download',
        'auth.download.description' => 'Version 1.0 (Nov 30, 2025) to install Rastro Timeline on your server.',
        'auth.download.button' => 'Download rastro-installer.zip',
